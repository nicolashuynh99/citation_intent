...
modeleFinal.trainable = False
modeleFinal.load_weights("./checkpoints/checkpoint1")
...
label_predicted = tf.argmax(predictions, axis = -1)


print(tf.confusion_matrix(tf.reshape(labels, axis = -1),tf.reshape(label_predicted, axis = -1)))
